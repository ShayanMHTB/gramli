...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("POST /post/{shortcode}/tags", s.handlePostTagAdd)
	mux.HandleFunc("POST /post/{shortcode}/untag", s.handlePostTagRemove)
	mux.HandleFunc("POST /post/{shortcode}/collections", s.handlePostCollections)
	mux.HandleFunc("POST /post/{shortcode}/delete", s.handlePostDelete)
